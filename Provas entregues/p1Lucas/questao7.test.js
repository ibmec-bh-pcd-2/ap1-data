...
//verificar se a função retorna o array correto:
...
describe ('tarifas', ()=>{
    it('Deve retornar o array correto', ()=>{
        const linhasOnibusMetropolitanos = [
          ...
          expect(tarifas(linhasOnibusMetropolitanos)).toEqual(resultadoEsperado);
    });
});

//questao c:

describe('linhaMelhorAvaliada',()=>{
    it('deve retornar a primeira linha com avaliacao maior ou igual a 4.5',()=>{
        const linhasOnibusMetropolitanos = [
            {
              id: 101,
              nomeLinha: "Terminal Central - Bairro Novo Horizonte",
          ...
          const resultadoEsperado1 = 'id: 303 - avaliação: 4.5';
          expect(linhaMelhorAvaliada(linhasOnibusMetropolitanos).toBe(resultadoEsperado1));
    });
});

// questao d

describe('tarifasMaisCaras',()=>{
    it('deve retornar um array vazio quando não houver linhas com tarifa superior a R$5',()=>{
        const linhasOnibusMetropolitanos = [
            {
              id: 101,
              nomeLinha: "Terminal Central - Bairro Novo Horizonte",
          ...
          expect(tarifasMaisCaras(linhasOnibusMetropolitanos).toEqual(resultadoEsperado2));
    });
    it ('deve retornar um array vazio quando não houver linhas com tarifa superior a R$5,00',()=>{
        const linhasOnibusMetropolitanos = [
            {
              id: 101,
              nomeLinha: "Terminal Central - Bairro Novo Horizonte",
          ...
          const resultadoEsperado4 = [{nome: "bairro da serra", tarifa:5.50}];

          expect (tarifasMaisCaras(linhasOnibusMetropolitanos).toEqual(resultadoEsperado4));
